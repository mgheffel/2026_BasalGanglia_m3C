...
# --- INPUTS ---
MANIFEST=~/epigenome/bican/protein_coding/bican_MSN_DRD1_EPHA4.order.tsv
...
echo "[✓] Per-timepoint DMR summaries written to $OUTDIR (DRD1-EPHA4_dms2_hypo_merged.*.tsv)" >&2
