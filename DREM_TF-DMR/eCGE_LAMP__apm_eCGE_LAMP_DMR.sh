...
# --- INPUTS ---
MANIFEST=~/epigenome/bican/protein_coding/bican_eCGE_LAMP.order.tsv
DMRS=~/epigenome/bican/protein_coding/CGE_LAMP5_allLAMP5_dms2_hypo_merged.bed   # chr start end id
...
DMRS_SORTED="$OUTDIR/CGE_LAMP5_allLAMP5_dms2_hypo_merged.sorted.bed"
...
while read -r FILE; do
  ...
  OUT="$OUTDIR/dmrs_eCGE_hypo.${LABEL}.tsv"
...
echo "[✓] Per-timepoint DMR summaries written to $OUTDIR (dmrs_eCGE_hypo.*.tsv)" >&2
