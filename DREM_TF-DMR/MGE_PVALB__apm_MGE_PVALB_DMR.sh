...
# --- INPUTS ---
MANIFEST=~/epigenome/bican/protein_coding/bican_MGE_PVALB.order.tsv
DMRS=~/epigenome/bican/protein_coding/MGE_P_all_dms2_hypo_merged.bed   # chr start end id
...
DMRS_SORTED="$OUTDIR/MGE_P_all_dms2_hypo_merged.bed.sorted.bed"
...
while read -r FILE; do
  ...
  OUT="$OUTDIR/dmrs_MGE_hypo.${LABEL}.tsv"
...
echo "[✓] Per-timepoint DMR summaries written to $OUTDIR (dmrs_MGE_hypo.*.tsv)" >&2
