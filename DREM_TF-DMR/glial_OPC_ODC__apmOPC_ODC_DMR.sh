...
# --- INPUTS ---
MANIFEST=~/epigenome/bican/protein_coding/bican_OPC_ODC.order.tsv
DMRS=~/epigenome/bican/protein_coding/OPDC_hypo_dmrs.200-250bp.id.bed   # chr start end id
...
DMRS_SORTED="$OUTDIR/OPDC_hypo_dmrs.id.sorted.bed"
...
while read -r FILE; do
  ...
  OUT="$OUTDIR/dmrs_OPDC_hypo.${LABEL}.tsv"
...
echo "[✓] Per-timepoint DMR summaries written to $OUTDIR (dmrs_OPDC_hypo.*.tsv)" >&2
